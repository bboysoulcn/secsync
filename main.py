...
def sync_secrets(source_namespace, target_namespaces, secret_names):
    # 加载Kubernetes配置
...
if __name__ == "__main__":
    ...
    if not source_ns or not target_ns_list or not secret_names:
        print("请设置环境变量 SOURCE_NAMESPACE, TARGET_NAMESPACES 和 SECRET_NAMES")
    else:
        sync_secrets(source_ns, target_ns_list, secret_names)
